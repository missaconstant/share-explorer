			...
			<html>
				...
				<body style="background:#dfdfdf;padding:30px;color:#333;">
					<div style="width:80%;margin:auto;text-align:center;">
						<a href="#">
							<img src="http://localhost:7000/THEME/img/logos/logo_annuaire.png" style="width:100px;margin-bottom:20px;"/>
						</a>
					</div>
				  	<div style="background:#fff;width:80%;margin:auto;">
				  		<div style="padding:20px 15px;">
				  			'.($ishtmlcontent ? utf8_encode($msg) : str_replace("\n", "<br/><br/>", $msg)).'
				  		</div>
				  	</div>
				  	<div style="text-align:center;color:#666;margin-top:15px;">
				  		&copy;copyright cnit@tresor.gouv.ci 2019
				  	</div>
				</body>
			</html>
			';
